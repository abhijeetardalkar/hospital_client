...
// import Background from "./img/curved-images/white-curved.jpg";

const ADMIN_DASH_PATH = "/a/dashboard";
const PATIENT_REG_PATH = "/patient/registration";
const DOCTOR_REG_PATH = "/doctor/registration";
...
const SideMenu = () => {
  ...
  const checkPath = (checkedMenu, path) => {
    let _path = type == "admin" ? "a" : type == "doctor" ? "d" : "p";
    // console.log({ checkedMenu, _path });
    return (
      location?.pathname == checkedMenu ||
      location?.pathname == `/${_path}/${checkedMenu}`
    );
  };
  useEffect(() => {
    async function a() {
  ...
  let path = type == "admin" ? "a" : type == "doctor" ? "d" : "p";
        ...
        <div class="sidenav-header">
          ...
          >
            <img
              ...
              alt="main_logo"
            />
            <span class="ms-1 font-weight-bold">E-HEALTH</span>
          </a>
        </div>
        ...
        >
          <ul class="navbar-nav">
            {menus?.map((item, inx) => {
              return (
                <li class="nav-item">
                  <Link
                    class={`nav-link  ${
                      checkPath(item.pathname) ? "active" : ""
                    }`}
                    to={
                      item.menu_name == "Dashboard"
                        ? `/${path}/${item.pathname}`
                        : `${item.pathname}`
                    }
                  ...
                  >
                    ...
                    <span class="nav-link-text ms-1">{item.menu_name}</span>
                  </Link>
                </li>
              );
            })}
            {/* <li class="nav-item">
              <Link
                class={`nav-link  ${
                  checkPath(ADMIN_DASH_PATH) ? "active" : ""
                }`}
                to={`/${path}/dashboard`}
              >
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
              <Link
                class={`nav-link  ${
                  checkPath(PATIENT_REG_PATH) ? "active" : ""
                }`}
            ...
            <li class="nav-item">
              <Link
                class={`nav-link  ${
                  checkPath(DOCTOR_REG_PATH) ? "active" : ""
                }`}
        ...
        <div class="sidenav-footer mx-3 ">
          ...
          >
            <div
              ...
              // style="background-image: url('./img/curved-images/white-curved.jpg')"
              style={{
